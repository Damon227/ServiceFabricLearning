...
namespace Microsoft.ServiceFabric.Actors
{
    ...
    internal static class Crc64
    {
        ...
        private static readonly ulong[] s_crc64Table =
        {
            0UL,
        ...
        public static ulong ToCrc64(byte[] value)
        {
            ...
            {
                uint num2 = (uint)(((int)(uint)(num1 >> 56) ^ value[index]) & byte.MaxValue);
                num1 = s_crc64Table[num2] ^ num1 << 8;
            }
        ...
        public static ulong ToCrc64(params byte[][] values)
        {
            ...
            for (int index1 = 0; index1 < values.Length; ++index1)
            {
                ...
                {
                    uint num2 = (uint)(((int)(uint)(num1 >> 56) ^ values[index1][index2]) & byte.MaxValue);
                    num1 = s_crc64Table[num2] ^ num1 << 8;
                }
            }
            return num1 ^ ulong.MaxValue;
        ...
        {
            return ToCrc64(value).ToString("X", CultureInfo.InvariantCulture);
        }
    }
}